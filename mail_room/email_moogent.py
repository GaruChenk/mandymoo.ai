...
def work():
    ...
    orders = get_orders()
    orders_last_five_minutes = [order for order in orders if datetime.fromisoformat(order.created_at) > datetime.now(timezone(timedelta(seconds=39600))) - timedelta(minutes=5)]
